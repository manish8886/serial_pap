...
# Generated by qmake (3.0) (Qt 5.0.2) on: Tue Jul 23 15:05:18 2013
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/serial_pap1.0.0/ && $(COPY_FILE) --parents main.cpp enumport.cpp .tmp/serial_pap1.0.0/ && (cd `dirname .tmp/serial_pap1.0.0` && $(TAR) serial_pap1.0.0.tar serial_pap1.0.0 && $(COMPRESS) serial_pap1.0.0.tar) && $(MOVE) `dirname .tmp/serial_pap1.0.0`/serial_pap1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/serial_pap1.0.0
