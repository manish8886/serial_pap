...
#define DL_IVY_MSG_ID 235
#define DL_IVY_GPS_MSG_ID 236
...
#define DOWNLINK_SEND_ARDRONE_NAVDATA(_trans, _dev, taille, nu_trame, ax, ay, az, vx, vy, vz, temperature_acc, temperature_gyro, ultrasound, us_debut_echo, us_fin_echo, us_association_echo, us_distance_echo, us_curve_time, us_curve_value, us_curve_ref, nb_echo, sum_echo, gradient, flag_echo_ini, pressure, temperature_pressure, mx, my, mz, chksum){ \
	if (DownlinkCheckFreeSpace(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+2+2+2+2+2+2+2+2+2+2+2+2+2+2+2+2+2+2+2+4+2+2+4+2+2+2+2+2))) {\
	  ...
	  DownlinkPutUint16ByAddr(_trans, _dev, (ay)); \
	  DownlinkPutUint16ByAddr(_trans, _dev, (az)); \
	  DownlinkPutInt16ByAddr(_trans, _dev, (vx)); \
	  DownlinkPutInt16ByAddr(_trans, _dev, (vy)); \
	  DownlinkPutInt16ByAddr(_trans, _dev, (vz)); \
	  DownlinkPutUint16ByAddr(_trans, _dev, (temperature_acc)); \
	  DownlinkPutUint16ByAddr(_trans, _dev, (temperature_gyro)); \
	  DownlinkPutUint16ByAddr(_trans, _dev, (ultrasound)); \
	  DownlinkPutUint16ByAddr(_trans, _dev, (us_debut_echo)); \
	  DownlinkPutUint16ByAddr(_trans, _dev, (us_fin_echo)); \
	  DownlinkPutUint16ByAddr(_trans, _dev, (us_association_echo)); \
	  DownlinkPutUint16ByAddr(_trans, _dev, (us_distance_echo)); \
	  DownlinkPutUint16ByAddr(_trans, _dev, (us_curve_time)); \
	  DownlinkPutUint16ByAddr(_trans, _dev, (us_curve_value)); \
	  DownlinkPutUint16ByAddr(_trans, _dev, (us_curve_ref)); \
	  DownlinkPutUint16ByAddr(_trans, _dev, (nb_echo)); \
	  DownlinkPutUint32ByAddr(_trans, _dev, (sum_echo)); \
...
#define DOWNLINK_SEND_DOWNLINK_STATUS(_trans, _dev, link_id, run_time, rx_bytes, rx_msgs, rx_err, rx_bytes_rate, rx_msgs_rate, ping_time){ \
	if (DownlinkCheckFreeSpace(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+1+4+4+4+4+4+4+4))) {\
	  DownlinkCountBytes(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+1+4+4+4+4+4+4+4)); \
	  DownlinkStartMessage(_trans, _dev, "DOWNLINK_STATUS", DL_DOWNLINK_STATUS, 0+1+4+4+4+4+4+4+4) \
	  DownlinkPutInt8ByAddr(_trans, _dev, (link_id)); \
...
#define DOWNLINK_SEND_MKK(_trans, _dev, nr, rpm, current, temp){ \
	if (DownlinkCheckFreeSpace(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+1+1+1+1))) {\
	  ...
	  DownlinkStartMessage(_trans, _dev, "MKK", DL_MKK, 0+1+1+1+1) \
	  DownlinkPutInt8ByAddr(_trans, _dev, (nr)); \
	  DownlinkPutUint8ByAddr(_trans, _dev, (rpm)); \
	  DownlinkPutInt8ByAddr(_trans, _dev, (current)); \
	  DownlinkPutInt8ByAddr(_trans, _dev, (temp)); \
	  DownlinkEndMessage(_trans, _dev ) \
	} else \
	  DownlinkOverrun(_trans, _dev ); \
}
...
#define DOWNLINK_SEND_DC_INFO(_trans, _dev, mode, utm_east, utm_north, course, buffer, dist, next_dist, start_x, start_y, start_angle, angle, last_block, count, shutter){ \
	if (DownlinkCheckFreeSpace(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+2+4+4+4+2+4+4+4+4+4+4+4+2+1))) {\
	  DownlinkCountBytes(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+2+4+4+4+2+4+4+4+4+4+4+4+2+1)); \
	  DownlinkStartMessage(_trans, _dev, "DC_INFO", DL_DC_INFO, 0+2+4+4+4+2+4+4+4+4+4+4+4+2+1) \
	  DownlinkPutInt16ByAddr(_trans, _dev, (mode)); \
	  DownlinkPutFloatByAddr(_trans, _dev, (utm_east)); \
	  DownlinkPutFloatByAddr(_trans, _dev, (utm_north)); \
	  DownlinkPutFloatByAddr(_trans, _dev, (course)); \
	  DownlinkPutUint16ByAddr(_trans, _dev, (buffer)); \
...
#define DOWNLINK_SEND_MPL3115_BARO(_trans, _dev, pressure, temp, alt){ \
	if (DownlinkCheckFreeSpace(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+4+2+4))) {\
	  DownlinkCountBytes(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+4+2+4)); \
	  DownlinkStartMessage(_trans, _dev, "MPL3115_BARO", DL_MPL3115_BARO, 0+4+2+4) \
	  DownlinkPutUint32ByAddr(_trans, _dev, (pressure)); \
...
#define DOWNLINK_SEND_LINK_STATUS(_trans, _dev, link_id, time_since_last_msg, run_time, rx_bytes, rx_msgs, rx_err, rx_bytes_rate, rx_msgs_rate, ping_time){ \
	if (DownlinkCheckFreeSpace(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+1+4+4+4+4+4+4+4+4))) {\
	  DownlinkCountBytes(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+1+4+4+4+4+4+4+4+4)); \
	  DownlinkStartMessage(_trans, _dev, "LINK_STATUS", DL_LINK_STATUS, 0+1+4+4+4+4+4+4+4+4) \
	  DownlinkPutUint8ByAddr(_trans, _dev, (link_id)); \
	  DownlinkPutFloatByAddr(_trans, _dev, (time_since_last_msg)); \
	  DownlinkPutUint32ByAddr(_trans, _dev, (run_time)); \
	  DownlinkPutUint32ByAddr(_trans, _dev, (rx_bytes)); \
	  DownlinkPutUint32ByAddr(_trans, _dev, (rx_msgs)); \
	  DownlinkPutUint32ByAddr(_trans, _dev, (rx_err)); \
...
#define DOWNLINK_SEND_GUIDANCE_H_INT(_trans, _dev, sp_x, sp_y, ref_x, ref_y, est_x, est_y){ \
	if (DownlinkCheckFreeSpace(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+4+4+4+4+4+4))) {\
	  DownlinkCountBytes(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+4+4+4+4+4+4)); \
	  DownlinkStartMessage(_trans, _dev, "GUIDANCE_H_INT", DL_GUIDANCE_H_INT, 0+4+4+4+4+4+4) \
...
#define DOWNLINK_SEND_ROTORCRAFT_CAM(_trans, _dev, tilt, pan){ \
	if (DownlinkCheckFreeSpace(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+2+2))) {\
	  DownlinkCountBytes(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+2+2)); \
	  DownlinkStartMessage(_trans, _dev, "ROTORCRAFT_CAM", DL_ROTORCRAFT_CAM, 0+2+2) \
	  DownlinkPutInt16ByAddr(_trans, _dev, (tilt)); \
...
#define DOWNLINK_SEND_FLOW_AP_OTF(_trans, _dev, counter, velocity, a_attack, a_sidesl, altitude, checksum){ \
	if (DownlinkCheckFreeSpace(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+4+2+2+2+4+1))) {\
	  DownlinkCountBytes(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+4+2+2+2+4+1)); \
	  DownlinkStartMessage(_trans, _dev, "FLOW_AP_OTF", DL_FLOW_AP_OTF, 0+4+2+2+2+4+1) \
	  DownlinkPutUint32ByAddr(_trans, _dev, (counter)); \
	  DownlinkPutInt16ByAddr(_trans, _dev, (velocity)); \
	  DownlinkPutInt16ByAddr(_trans, _dev, (a_attack)); \
	  DownlinkPutInt16ByAddr(_trans, _dev, (a_sidesl)); \
	  DownlinkPutInt32ByAddr(_trans, _dev, (altitude)); \
	  DownlinkPutUint8ByAddr(_trans, _dev, (checksum)); \
	  DownlinkEndMessage(_trans, _dev ) \
	} else \
	  DownlinkOverrun(_trans, _dev ); \
}
...
#define DOWNLINK_SEND_IMU_MAG_CURRENT_CALIBRATION(_trans, _dev, mx, my, mz, electrical_current){ \
	if (DownlinkCheckFreeSpace(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+4+4+4+4))) {\
	  DownlinkCountBytes(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+4+4+4+4)); \
	  DownlinkStartMessage(_trans, _dev, "IMU_MAG_CURRENT_CALIBRATION", DL_IMU_MAG_CURRENT_CALIBRATION, 0+4+4+4+4) \
	  DownlinkPutInt32ByAddr(_trans, _dev, (mx)); \
	  DownlinkPutInt32ByAddr(_trans, _dev, (my)); \
	  DownlinkPutInt32ByAddr(_trans, _dev, (mz)); \
	  DownlinkPutInt32ByAddr(_trans, _dev, (electrical_current)); \
	  DownlinkEndMessage(_trans, _dev ) \
	} else \
	  DownlinkOverrun(_trans, _dev ); \
}
...
#define DOWNLINK_SEND_UART_ERRORS(_trans, _dev, overrun_cnt, noise_err_cnt, framing_err_cnt, bus_number){ \
	if (DownlinkCheckFreeSpace(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+2+2+2+1))) {\
	  ...
	  DownlinkStartMessage(_trans, _dev, "UART_ERRORS", DL_UART_ERRORS, 0+2+2+2+1) \
	  DownlinkPutUint16ByAddr(_trans, _dev, (overrun_cnt)); \
	  DownlinkPutUint16ByAddr(_trans, _dev, (noise_err_cnt)); \
	  DownlinkPutUint16ByAddr(_trans, _dev, (framing_err_cnt)); \
...
#define DOWNLINK_SEND_AHRS_ARDRONE2(_trans, _dev, state, control_state, phi, theta, psi, speed_x, speed_y, speed_z, accel_x, accel_y, accel_z, altitude, battery){ \
	if (DownlinkCheckFreeSpace(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+4+4+4+4+4+4+4+4+4+4+4+4+4))) {\
	  DownlinkCountBytes(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+4+4+4+4+4+4+4+4+4+4+4+4+4)); \
	  DownlinkStartMessage(_trans, _dev, "AHRS_ARDRONE2", DL_AHRS_ARDRONE2, 0+4+4+4+4+4+4+4+4+4+4+4+4+4) \
	  DownlinkPutUint32ByAddr(_trans, _dev, (state)); \
	  DownlinkPutUint32ByAddr(_trans, _dev, (control_state)); \
	  DownlinkPutFloatByAddr(_trans, _dev, (phi)); \
	  DownlinkPutFloatByAddr(_trans, _dev, (theta)); \
	  DownlinkPutFloatByAddr(_trans, _dev, (psi)); \
	  DownlinkPutFloatByAddr(_trans, _dev, (speed_x)); \
	  DownlinkPutFloatByAddr(_trans, _dev, (speed_y)); \
	  DownlinkPutFloatByAddr(_trans, _dev, (speed_z)); \
	  DownlinkPutFloatByAddr(_trans, _dev, (accel_x)); \
	  DownlinkPutFloatByAddr(_trans, _dev, (accel_y)); \
	  DownlinkPutFloatByAddr(_trans, _dev, (accel_z)); \
	  DownlinkPutInt32ByAddr(_trans, _dev, (altitude)); \
	  DownlinkPutUint32ByAddr(_trans, _dev, (battery)); \
	  DownlinkEndMessage(_trans, _dev ) \
	} else \
	  DownlinkOverrun(_trans, _dev ); \
}
...
#define DOWNLINK_SEND_PX4FLOW(_trans, _dev, sensor_id, flow_x, flow_y, flow_comp_m_x, flow_comp_m_y, quality, ground_distance){ \
	if (DownlinkCheckFreeSpace(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+1+2+2+4+4+1+4))) {\
	  DownlinkCountBytes(_trans, _dev, DownlinkSizeOf(_trans, _dev, 0+1+2+2+4+4+1+4)); \
	  DownlinkStartMessage(_trans, _dev, "PX4FLOW", DL_PX4FLOW, 0+1+2+2+4+4+1+4) \
	  DownlinkPutUint8ByAddr(_trans, _dev, (sensor_id)); \
	  DownlinkPutInt16ByAddr(_trans, _dev, (flow_x)); \
	  DownlinkPutInt16ByAddr(_trans, _dev, (flow_y)); \
	  DownlinkPutFloatByAddr(_trans, _dev, (flow_comp_m_x)); \
	  DownlinkPutFloatByAddr(_trans, _dev, (flow_comp_m_y)); \
	  DownlinkPutUint8ByAddr(_trans, _dev, (quality)); \
	  DownlinkPutFloatByAddr(_trans, _dev, (ground_distance)); \
	  DownlinkEndMessage(_trans, _dev ) \
	} else \
	  DownlinkOverrun(_trans, _dev ); \
}
...
#define DL_DOWNLINK_STATUS_link_id(_payload) ((int8_t)(*((uint8_t*)_payload+2)))
#define DL_DOWNLINK_STATUS_run_time(_payload) ((uint32_t)(*((uint8_t*)_payload+3)|*((uint8_t*)_payload+3+1)<<8|((uint32_t)*((uint8_t*)_payload+3+2))<<16|((uint32_t)*((uint8_t*)_payload+3+3))<<24))
#define DL_DOWNLINK_STATUS_rx_bytes(_payload) ((uint32_t)(*((uint8_t*)_payload+7)|*((uint8_t*)_payload+7+1)<<8|((uint32_t)*((uint8_t*)_payload+7+2))<<16|((uint32_t)*((uint8_t*)_payload+7+3))<<24))
#define DL_DOWNLINK_STATUS_rx_msgs(_payload) ((uint32_t)(*((uint8_t*)_payload+11)|*((uint8_t*)_payload+11+1)<<8|((uint32_t)*((uint8_t*)_payload+11+2))<<16|((uint32_t)*((uint8_t*)_payload+11+3))<<24))
#define DL_DOWNLINK_STATUS_rx_err(_payload) ((uint32_t)(*((uint8_t*)_payload+15)|*((uint8_t*)_payload+15+1)<<8|((uint32_t)*((uint8_t*)_payload+15+2))<<16|((uint32_t)*((uint8_t*)_payload+15+3))<<24))
#define DL_DOWNLINK_STATUS_rx_bytes_rate(_payload) (({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_payload+19)|*((uint8_t*)_payload+19+1)<<8|((uint32_t)*((uint8_t*)_payload+19+2))<<16|((uint32_t)*((uint8_t*)_payload+19+3))<<24); _f.f; }))
#define DL_DOWNLINK_STATUS_rx_msgs_rate(_payload) (({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_payload+23)|*((uint8_t*)_payload+23+1)<<8|((uint32_t)*((uint8_t*)_payload+23+2))<<16|((uint32_t)*((uint8_t*)_payload+23+3))<<24); _f.f; }))
#define DL_DOWNLINK_STATUS_ping_time(_payload) (({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_payload+27)|*((uint8_t*)_payload+27+1)<<8|((uint32_t)*((uint8_t*)_payload+27+2))<<16|((uint32_t)*((uint8_t*)_payload+27+3))<<24); _f.f; }))
...
#define DL_MKK_nr(_payload) ((int8_t)(*((uint8_t*)_payload+2)))
#define DL_MKK_rpm(_payload) ((uint8_t)(*((uint8_t*)_payload+3)))
#define DL_MKK_current(_payload) ((int8_t)(*((uint8_t*)_payload+4)))
...
#define DL_DC_INFO_buffer(_payload) ((uint16_t)(*((uint8_t*)_payload+16)|*((uint8_t*)_payload+16+1)<<8))
#define DL_DC_INFO_dist(_payload) (({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_payload+18)|*((uint8_t*)_payload+18+1)<<8|((uint32_t)*((uint8_t*)_payload+18+2))<<16|((uint32_t)*((uint8_t*)_payload+18+3))<<24); _f.f; }))
#define DL_DC_INFO_next_dist(_payload) (({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_payload+22)|*((uint8_t*)_payload+22+1)<<8|((uint32_t)*((uint8_t*)_payload+22+2))<<16|((uint32_t)*((uint8_t*)_payload+22+3))<<24); _f.f; }))
#define DL_DC_INFO_start_x(_payload) (({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_payload+26)|*((uint8_t*)_payload+26+1)<<8|((uint32_t)*((uint8_t*)_payload+26+2))<<16|((uint32_t)*((uint8_t*)_payload+26+3))<<24); _f.f; }))
#define DL_DC_INFO_start_y(_payload) (({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_payload+30)|*((uint8_t*)_payload+30+1)<<8|((uint32_t)*((uint8_t*)_payload+30+2))<<16|((uint32_t)*((uint8_t*)_payload+30+3))<<24); _f.f; }))
#define DL_DC_INFO_start_angle(_payload) (({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_payload+34)|*((uint8_t*)_payload+34+1)<<8|((uint32_t)*((uint8_t*)_payload+34+2))<<16|((uint32_t)*((uint8_t*)_payload+34+3))<<24); _f.f; }))
#define DL_DC_INFO_angle(_payload) (({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_payload+38)|*((uint8_t*)_payload+38+1)<<8|((uint32_t)*((uint8_t*)_payload+38+2))<<16|((uint32_t)*((uint8_t*)_payload+38+3))<<24); _f.f; }))
#define DL_DC_INFO_last_block(_payload) (({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_payload+42)|*((uint8_t*)_payload+42+1)<<8|((uint32_t)*((uint8_t*)_payload+42+2))<<16|((uint32_t)*((uint8_t*)_payload+42+3))<<24); _f.f; }))
#define DL_DC_INFO_count(_payload) ((int16_t)(*((uint8_t*)_payload+46)|*((uint8_t*)_payload+46+1)<<8))
#define DL_DC_INFO_shutter(_payload) ((uint8_t)(*((uint8_t*)_payload+48)))
...
#define DL_LINK_STATUS_link_id(_payload) ((uint8_t)(*((uint8_t*)_payload+2)))
#define DL_LINK_STATUS_time_since_last_msg(_payload) (({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_payload+3)|*((uint8_t*)_payload+3+1)<<8|((uint32_t)*((uint8_t*)_payload+3+2))<<16|((uint32_t)*((uint8_t*)_payload+3+3))<<24); _f.f; }))
#define DL_LINK_STATUS_run_time(_payload) ((uint32_t)(*((uint8_t*)_payload+7)|*((uint8_t*)_payload+7+1)<<8|((uint32_t)*((uint8_t*)_payload+7+2))<<16|((uint32_t)*((uint8_t*)_payload+7+3))<<24))
#define DL_LINK_STATUS_rx_bytes(_payload) ((uint32_t)(*((uint8_t*)_payload+11)|*((uint8_t*)_payload+11+1)<<8|((uint32_t)*((uint8_t*)_payload+11+2))<<16|((uint32_t)*((uint8_t*)_payload+11+3))<<24))
#define DL_LINK_STATUS_rx_msgs(_payload) ((uint32_t)(*((uint8_t*)_payload+15)|*((uint8_t*)_payload+15+1)<<8|((uint32_t)*((uint8_t*)_payload+15+2))<<16|((uint32_t)*((uint8_t*)_payload+15+3))<<24))
#define DL_LINK_STATUS_rx_err(_payload) ((uint32_t)(*((uint8_t*)_payload+19)|*((uint8_t*)_payload+19+1)<<8|((uint32_t)*((uint8_t*)_payload+19+2))<<16|((uint32_t)*((uint8_t*)_payload+19+3))<<24))
#define DL_LINK_STATUS_rx_bytes_rate(_payload) (({ union { uint32_t u; float f; } _f; _f.u = (uint32_t)(*((uint8_t*)_payload+23)|*((uint8_t*)_payload+23+1)<<8|((uint32_t)*((uint8_t*)_payload+23+2))<<16|((uint32_t)*((uint8_t*)_payload+23+3))<<24); _f.f; }))
